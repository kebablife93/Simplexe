 <?php include("views/menu.php"); ?>
    ...
    <div class="container">
    	<div class="jumbotron">
			...
			<img src="img/biography/dantzig_baby.jpg" width="407" height="300" class="bio" style="padding-left:150px;" alt="George Dantzig" title="George Dantzig " /> <img src="img/Biography/dantzig_brothers.jpg" width="407" height="300" class="bio" alt="George Dantzig" title="George Dantzig" />
			<p>
			...
			<img src="img/Biography/dantzig_michigan.jpg" width="215" height="300" class="drt" alt="George " title="George B. Dantzig"/>
			...
			<img src="img/Biography/dantzig_profesor.jpg" width="195" height="250" class="gch" alt="George Bernard" title="George Bernard" />
			...
			<img src="img/Biography/dantzig_rand.jpg" width="310" height="414" class="gch" alt=" George B. Dantzig" title="George B. Dantzig" />
			<p>
			...
			<img src="img/Biography/dantzig_profesor_2.jpg" width="220" height="300" class="drt" alt="George Bernard" title="George Bernard" />
			...
			<img src="img/Biography/dantzig_iiasa.jpg" width="196" height="290" class="drt" alt="George Bernard Dantzig" title="George Bernard Dantzig" />
			...
			<img src="img/Biography/dantzig_ford.jpg" width="420" height="300" class="centre img" alt="Gerald Ford" title="Gerald Ford" />
			...
			<img src="img/Biography/dantzig_thapa.jpg" width="187" height="196" class="gch" alt="George Bernard" title="George Bernard" />
